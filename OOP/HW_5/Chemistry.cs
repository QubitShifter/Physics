namespace HW_5
{
    public class Chemistry : ScienceLab
    {
        ...
        public Chemistry(string scienceSubBranch, string mainScienceBranch, string nameOfScience, string subjectOf, int semester, string academicDegree, string research)
        ...
        public void DisplayInfo()
        {
            ...
            Console.WriteLine($"{ScienceSubBranch} has different subjects like BioChemistry, Nuclear Chemistry, Organic Chemistry, Inorganic Chemistry adn so on..");
        ...
        private void DoChemistryProblems()
        {
            Console.WriteLine("--------------------------------------------------------------------");
            Console.WriteLine("\nElectrons change their energy levels. Molecules change their bonds. \nElements combine and change into compounds.");
            Console.WriteLine("\nIt is all about reactions! Let's consider combustion:");
